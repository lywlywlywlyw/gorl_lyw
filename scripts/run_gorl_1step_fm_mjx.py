...
def load_states(
    ...
    config: Config,
    stage_timesteps: int,
) -> tuple[dict[str, Any], encoder_ppo.EncoderState, Decoder1StepFMState]:
...
def train_decoder(
    ...
    for epoch in trange(config.fm_num_epochs, desc=f"Stage {stage} 1-step FM"):
        losses = []
