...
class TrainingConfig:
    ...
    encoder_timesteps_per_stage: Annotated[str | None, tyro.conf.arg(help="Comma-separated timesteps for each stage (e.g., '60000000,60000000,30000000,30000000')")] =  ",".join(["393216"] * 48)#"4800000,4800000,2400000,2400000"#"60000000,60000000,30000000,30000000"
